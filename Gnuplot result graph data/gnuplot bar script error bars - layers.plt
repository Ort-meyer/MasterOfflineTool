...
#set title "Hidden Layers"
set term svg
set output "layers.svg"
set style fill solid 1.00 border 0
set style histogram errorbars gap 2 lw 1
set style data histogram
set xtics rotate by -45
set grid ytics
set xlabel "Hidden Layer configurations"
...
plot 'layers.txt' using 2:3:xtic(1) ti "True positive" linecolor rgb "#00FF00", \
